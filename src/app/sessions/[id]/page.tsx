  ...
  return (
    <div className="px-4 py-6 lg:px-8 lg:py-8 max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-[var(--on-surface)] mb-1">{session.title || "Session"}</h1>
      ...
      {session.goals.length > 0 && (
        <Card className="mb-4 !p-4">
          <h2 className="text-sm font-semibold text-[var(--on-surface)] mb-3">Objectifs</h2>
          <div className="space-y-2">

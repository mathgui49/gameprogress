...
const GUIDE_FEATURES: GuideFeature[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Saisie vocale pour noter rapidement",
  ...
  },
  {
    ...
    description: "Regroupe tes posts en collections thématiques, collabore avec tes wings et partage via lien avec expiration.",
    details: [
  ...
  {
    title: "Parrainage",
    description: "Invite tes potes avec ton lien unique. Tu gagnes 7 jours de GameMax par inscription.",
    details: [
      "Lien de parrainage unique",
      "7 jours GameMax offerts par filleul inscrit",
      "Cumul illimité de jours offerts",

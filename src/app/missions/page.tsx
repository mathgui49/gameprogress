                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <Badge className={m.type === "daily" ? "bg-[#c084fc]/15 text-[#c084fc]" : m.type === "weekly" ? "bg-[#818cf8]/15 text-[#818cf8]" : "bg-[#1a1626] text-[#a09bb2]"}>
                              {m.type === "daily" ? "Quotidien" : m.type === "weekly" ? "Hebdo" : "Custom"}
                            </Badge>
                          </div>
                          <p className="text-xs text-[#6b6580]">{m.description}</p>
                        </div>

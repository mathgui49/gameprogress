    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--surface-low)] px-4">
      <div className="w-full max-w-sm text-center animate-fade-in">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-white hover:bg-gray-50 text-gray-800 font-medium text-sm transition-all shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
        >

...
export default function SettingsPage() {
  ...
  return (
    <div className="px-4 py-6 lg:px-8 lg:py-8 max-w-2xl mx-auto animate-fade-in">
      <div className="mb-8">
        <h1 className="text-2xl lg:text-3xl font-[family-name:var(--font-grotesk)] font-bold tracking-tight mb-1"><span className="bg-gradient-to-r from-[#8a839e] to-[#c084fc] bg-clip-text text-transparent animate-gradient-text">Paramètres</span></h1>
        ...
        <div className="relative">
          ...
          {subLoaded && isPremium ? (
            ...
            <div className="space-y-4">
              ...
              <Button onClick={() => window.location.href = "/abonnement"} className="w-full">

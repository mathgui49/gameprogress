...
export function generateSeedInteractions(): Interaction[] {
  ...
  const items: Omit<Interaction, "id" | "createdAt">[] = [
    { date: new Date(now.getTime() - 1 * 3600000).toISOString(), firstName: "Sophie", note: "Rencontre au cafe, conversation naturelle sur les voyages. Elle revenait du Japon.", location: "Cafe Flore, Paris 6e", type: "direct", result: "close", duration: "long", feelingScore: 9 },
    { date: new Date(now.getTime() - 5 * 3600000).toISOString(), firstName: "Emma", note: "Approche en librairie, elle cherchait Murakami. Echange sympa mais pressee.", location: "Librairie Gibert, Paris 5e", type: "situational", result: "neutral", duration: "medium", feelingScore: 7 },
    { date: new Date(now.getTime() - 24 * 3600000).toISOString(), firstName: "Clara", note: "Directe dans la rue, bonne energie. Echange de numeros.", location: "Rue de Rivoli", type: "direct", result: "close", duration: "medium", feelingScore: 8 },
    { date: new Date(now.getTime() - 26 * 3600000).toISOString(), firstName: "", note: "Approche au parc, en couple finalement.", location: "Jardin du Luxembourg", type: "direct", result: "rejection", duration: "short", feelingScore: 5 },
    { date: new Date(now.getTime() - 48 * 3600000).toISOString(), firstName: "Lea", note: "Rencontre en soiree chez des amis. Tres bon feeling, longue conversation.", location: "Soiree privee, Paris 11e", type: "indirect", result: "close", duration: "long", feelingScore: 9 },
    { date: new Date(now.getTime() - 72 * 3600000).toISOString(), firstName: "Camille", note: "Approche directe, elle attendait le metro. Rapide mais bien execute.", location: "Metro Chatelet", type: "direct", result: "neutral", duration: "short", feelingScore: 6 },
    { date: new Date(now.getTime() - 96 * 3600000).toISOString(), firstName: "Julie", note: "Discussion spontanee a la salle de sport.", location: "Basic Fit, Paris 3e", type: "situational", result: "close", duration: "long", feelingScore: 8 },
    { date: new Date(now.getTime() - 120 * 3600000).toISOString(), firstName: "", note: "Approche dans le train, pas le bon moment.", location: "TGV Paris-Lyon", type: "direct", result: "rejection", duration: "short", feelingScore: 4 },
    { date: new Date(now.getTime() - 144 * 3600000).toISOString(), firstName: "Alice", note: "Rencontre au vernissage. Echange Instagram.", location: "Galerie Perrotin, Paris 3e", type: "indirect", result: "close", duration: "medium", feelingScore: 7 },
    { date: new Date(now.getTime() - 168 * 3600000).toISOString(), firstName: "Ines", note: "Approche en terrasse, conversation sur la musique.", location: "Terrasse, Oberkampf", type: "situational", result: "neutral", duration: "medium", feelingScore: 6 },
  ];

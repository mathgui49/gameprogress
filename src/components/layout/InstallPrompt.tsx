...
export function InstallPrompt() {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-end sm:items-center justify-center animate-fade-in">
      <div className="absolute inset-0 bg-[var(--backdrop)] backdrop-blur-sm" onClick={dismiss} />
      <div className="relative w-full max-w-sm bg-[var(--surface)] border border-[var(--border)] rounded-t-2xl sm:rounded-2xl p-6 shadow-[0_0_48px_-12px_var(--neon-purple)] animate-scale-in mx-4 sm:mx-0">
        {/* Icon */}
        <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#c084fc] to-[#f472b6] flex items-center justify-center mx-auto mb-4 shadow-[0_0_20px_-4px_var(--neon-purple)]">
        ...
        {installEvent ? (
          <div className="space-y-3">
            ...
            <button onClick={dismiss} className="w-full text-sm text-[var(--outline)] hover:text-[var(--on-surface-variant)] transition-colors py-2">
              Plus tard
            </button>
          </div>
        ) : isIOS ? (
          ...
          <div className="space-y-4">
            <div className="space-y-3 bg-[var(--surface-low)] rounded-xl p-4">
              <div className="flex items-start gap-3">
                <span className="w-6 h-6 rounded-full bg-[var(--primary)]/15 text-[var(--primary)] flex items-center justify-center text-xs font-bold shrink-0">1</span>
                <p className="text-sm text-[var(--on-surface-variant)]">Appuie sur le bouton <span className="text-[var(--on-surface)] font-medium">Partager</span> <svg className="inline w-4 h-4 text-[var(--primary)] -mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 8.25H7.5a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25H15M9 12l3-3m0 0l3 3m-3-3v12" /></svg> en bas de Safari</p>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-[var(--on-surface-variant)]">Confirme en appuyant sur <span className="text-[var(--on-surface)] font-medium">Ajouter</span></p>
              </div>
            </div>
            <button onClick={dismiss} className="w-full text-sm text-[var(--outline)] hover:text-[var(--on-surface-variant)] transition-colors py-2">
              J&apos;ai compris
          ...
          <div className="space-y-4">
            <div className="space-y-3 bg-[var(--surface-low)] rounded-xl p-4">
              <div className="flex items-start gap-3">
                <span className="w-6 h-6 rounded-full bg-[var(--primary)]/15 text-[var(--primary)] flex items-center justify-center text-xs font-bold shrink-0">
                  <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" /></svg>
                </span>
                <p className="text-sm text-[var(--on-surface-variant)]">Appuie sur <kbd className="px-1.5 py-0.5 rounded bg-[var(--surface-high)] text-[var(--on-surface)] text-xs font-mono">Ctrl+D</kbd> pour ajouter aux favoris</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="w-6 h-6 rounded-full bg-[var(--primary)]/15 text-[var(--primary)] flex items-center justify-center text-xs font-bold shrink-0">
                  <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" /></svg>
                </span>
                <p className="text-sm text-[var(--on-surface-variant)]">Ou clique sur l&apos;icone d&apos;installation <svg className="inline w-4 h-4 text-[var(--primary)] -mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" /></svg> dans la barre d&apos;adresse</p>
              </div>
            </div>
            <button onClick={dismiss} className="w-full text-sm text-[var(--outline)] hover:text-[var(--on-surface-variant)] transition-colors py-2">
              J&apos;ai compris

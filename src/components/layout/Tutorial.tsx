...
const STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    title: "Sessions",
    description: "Regroupe tes interactions par session (soirée, sortie, workshop...). Invite tes wings à participer et retrouve tout dans ton calendrier.",
    tip: "Tes wings recevront une notification et pourront accepter ou décliner l'invitation.",
  },
  {
    icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z",
    title: "Pipeline & Contacts",
    description: "Gère tes contacts comme un pipeline : Lead, Numéro, Date planifié, En relation... Suis l'évolution de chaque relation.",
  ...
  },
  {
    ...
    tip: "Tu contrôles ce que tes wings voient dans Profil > Confidentialité.",
  },
  {
    icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6",
    title: "Progression & Stats",
    description: "Visualise ta progression avec des graphiques détaillés : nombre d'interactions, taux de succès, évolution par semaine.",
    tip: "Consulte aussi le classement pour te comparer avec les autres utilisateurs.",
  },
  {
    icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4",
    title: "Missions & XP",
    description: "Complète des missions quotidiennes et hebdomadaires pour gagner de l'XP. Monte de niveau et débloque des badges.",
    tip: "Les missions se renouvellent chaque jour — connecte-toi régulièrement pour maintenir ta streak !",
  },
  {
    icon: "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z",
    title: "Journal & Feed",
    description: "Écris dans ton journal pour documenter tes réflexions et apprentissages. Partage des posts dans le feed pour inspirer la communauté.",
    tip: "Choisis la visibilité de chaque entrée : privé, wings seulement, ou public.",
  },
  {
    icon: "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.066-2.573c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z",
    title: "Profil & Paramètres",
    description: "Personnalise ton profil public (photo, bio, ville), gère ta confidentialité, et configure l'apparence de l'app.",
    tip: "Accède à ton profil et paramètres via ton avatar en haut à droite.",
  },
];

...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/reports", label: "Statistiques", icon: "M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
      ...
      {subLoaded && isPremium && (
        <div className="px-3 py-2">
          <div className="flex items-center justify-center gap-1.5 px-3 py-2 rounded-[12px] bg-gradient-to-r from-[var(--primary)]/8 to-[var(--secondary)]/8 border border-[var(--primary)]/15">
            ...
            <span className="text-[10px] font-bold bg-gradient-to-r from-[var(--primary)] to-[var(--secondary)] bg-clip-text text-transparent animate-gradient-text">{PLAN_NAME_PRO}</span>
          </div>
        </div>
      )}

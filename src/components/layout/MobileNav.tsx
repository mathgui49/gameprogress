...
const TABS = [
  ...
  { id: "social", label: "Social", href: "/wings", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M9 20H4v-2a3 3 0 015.356-1.857M13 7a4 4 0 11-8 0 4 4 0 018 0zm6 3a2 2 0 11-4 0 2 2 0 014 0z", matchPaths: ["/wings", "/feed", "/leaderboard"] },
  { id: "moi", label: "Moi", href: "/progression", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6", matchPaths: ["/progression", "/journal", "/missions"] },
];

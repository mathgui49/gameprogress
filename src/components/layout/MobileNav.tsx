...
const TABS = [
  ...
  { id: "search", label: "Recherche", href: "#search", icon: "M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" },
          ...
          if (tab.id === "search") {
            return (
              <button
                ...
                className="flex flex-col items-center gap-0.5 py-1.5 px-4 rounded-[14px] transition-all min-w-[56px] text-[var(--outline-variant)]"
              >

...
export function Modal({ open, onClose, title, children }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center" role="dialog" aria-modal="true" aria-label={title}>
      ...
      <div className="relative w-full max-w-lg glass-heavy rounded-t-[var(--radius-xl)] sm:rounded-[var(--radius-xl)] p-6 max-h-[85vh] overflow-y-auto overscroll-contain animate-scale-in shadow-[0_0_64px_-16px_var(--neon-purple),0_32px_64px_-16px_rgba(0,0,0,0.5)] glass-reflect">
        {title && (
